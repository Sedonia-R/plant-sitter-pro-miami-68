		...
		<div className="text-center container-fluid mt-5">
            ...
            <div className="d-flex flex-wrap justify-content-center mt-4">
                <div className="justify-content-center p-4">
                    ...
                    <a href="https://www.treehugger.com/how-water-houseplants-correctly-4858755"><p className="diphylleia-regular fs-4 text-center text-black">How to Water Houseplants</p></a>
                </div>
                <div className="justify-content-center p-4">
                    ...
                    <a href="https://www.npr.org/2024/05/06/1249310672/plant-intelligence-the-light-eaters-zoe-schlanger"><p className="diphylleia-regular fs-4 text-center text-black">Plants are Intelligent?!</p></a>
                </div>
                <div className="justify-content-center p-4">
                    ...
                    <a href="https://ted2sub.org/talks/suzanne_simard_how_trees_talk_to_each_other"><p className="diphylleia-regular fs-4 text-center text-black">Trees Talk to Each Other</p></a>
                </div>
                <div className="justify-content-center p-4">
                    ...
                    <a href="https://www.smithsonianmag.com/smart-news/worlds-worst-invasive-weed-sold-us-garden-centers-180978481/"><p className="diphylleia-regular fs-4 text-center text-black">Beware Buying Invasives</p></a>
                </div>
            </div>
        </div>
	);
